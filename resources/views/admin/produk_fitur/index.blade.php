    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
        <div>
            <div class="flex items-center gap-2 mb-2">
                <a href="{{ route('admin.produk.index') }}" class="text-sm font-bold text-slate-400 hover:text-slate-600">Produk</a>
                <span class="text-slate-300">/</span>
                <span class="text-sm font-bold text-slate-600">Fitur</span>
            </div>
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Kelola Fitur Portofolio</h1>
            <p class="text-slate-500 mt-1">Portofolio: <span class="font-bold text-slate-700">{{ $produk->nama }}</span></p>
        </div>
        
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.produk.fitur.create', $produk->id) }}" class="inline-flex items-center justify-center px-5 py-3 bg-indigo-600 text-white font-bold rounded-2xl hover:bg-indigo-700 hover:scale-105 transition-all shadow-lg shadow-indigo-100">
