...
<div>
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
        ...
        <div class="flex items-center gap-3 flex-wrap">
            <a href="{{ url('/') }}" class="inline-flex items-center px-5 py-3 bg-white border border-slate-200 text-slate-600 font-bold rounded-2xl hover:bg-slate-50 transition-all shadow-sm">
            ...
            <a href="{{ route('admin.blog.index') }}" class="inline-flex items-center justify-center px-5 py-3 bg-amber-500 text-white font-bold rounded-2xl hover:bg-amber-600 hover:scale-105 transition-all shadow-lg shadow-amber-100">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
