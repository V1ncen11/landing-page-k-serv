...
@section('content')
<div class="pt-32 pb-20 bg-white dark:bg-slate-900 min-h-screen">
    <div class="max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center mb-24">
            <div class="relative">
                ...
                <img src="/images/hero_startup.svg" alt="Tentang K-SERV" class="w-full relative z-10" style="filter: drop-shadow(0 20px 30px rgba(0,0,0,0.1));">
            </div>
            <div>
        ...
        <div class="bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 rounded-3xl p-10 md:p-16 max-w-4xl mx-auto text-center shadow-sm">
            <h3 class="text-sm font-bold text-[#673de6] tracking-widest uppercase mb-6">Founder</h3>
            <div class="w-28 h-28 mx-auto bg-gradient-to-br from-[#673de6] to-purple-500 text-white rounded-full flex items-center justify-center text-4xl font-black mb-6 shadow-xl shadow-purple-500/20">
                KN
            </div>
